...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的农民工', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.azzzdaily.com', // 网站地址
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Notion BLOG', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
        process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '这是一个Blog', // 站点描述，被notion中的页面描述覆盖
